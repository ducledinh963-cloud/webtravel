<?php
/**
 * Script sao chép xoay vòng hình ảnh chất lượng cao thành 60 ảnh du thuyền cruise1.png - cruise60.png
 */
...
for ($i = 1; $i <= 60; $i++) {
    ...
    $target_image = $target_dir . 'cruise' . $i . '.png';
...
echo "Thành công: Đã tạo xong $success_count/60 hình ảnh du thuyền tại thư mục uploads/.\n";
?>
