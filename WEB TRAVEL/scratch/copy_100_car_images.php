<?php
/**
 * Script sao chép xoay vòng hình ảnh chất lượng cao thành 100 ảnh xe du lịch car1.png - car100.png
 */
...
echo "Thành công: Đã tạo xong $success_count/100 hình ảnh xe du lịch tại thư mục uploads/.\n";
?>
